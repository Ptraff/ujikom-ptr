...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && (isset($_POST['like']) || isset($_POST['dislike']))) {
    ...
    header("Location: detail-image-user.php?id=$image_id&total_likes=$total_likes");
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['add_comment'])) {
        ...
        header("Location: detail-image-user.php?id=$image_id");
        exit();
        ...
        // Redirect kembali ke halaman produk
        header("Location: detail-image-user.php?id=$p->image_id");
        exit();
    }
}
?>
...
<style>
        ...
        .download-button {
            ...
            cursor: pointer;
            margin-top: 10px;
            text-decoration: none; /* Agar tautan tidak terlihat underline */
            display: inline-block; /* Agar tombol muncul sejajar dengan teks */
        }
    </style>
        ...
        <div class="container">
            ...
            <div class="box">
                ...
                <div class="col-2">
                   ...
                   <form method="post" action="detail-image-user.php?id=<?php echo isset($_GET['id']) ? $_GET['id'] : ''; ?>">
                   ...
                   <!-- Tombol Download -->
<a href="foto/<?php echo $p->image ?>" download="<?php echo $p->image_name ?>" class="download-button"><i class="fas fa-download"></i> Download Gambar</a>
                   ...
                   <?php
                        ...
                        if (mysqli_num_rows($comments_result) > 0) {
                            ...
                            while ($comment = mysqli_fetch_assoc($comments_result)) {
                                ...
                                echo '<form method="post" action="detail-image-user.php?id='.$p->image_id.'">';
